...
def change_password(request):
    if request.method == 'POST':
        ...
        cop=request.POST['confirmpassword']

        user=authenticate(username=request.user.username,password=cp)
...
def delete_feedback(request,pid):
  ...
  feedback.delete()
  messages.success(request,"feedback is deleted")
...
def contactview(request):
    if request.method == 'POST':
        ...
        ct=Contact(name=name,email=email,subject=subject)
        ct.save()
